...
const TestimonialCard = ({ name, role, testimonial, image }) => {
  return (
    <div className="bg-white hover:scale-95 transition ease-in-out font-Poppins p-6 rounded-lg shadow-lg max-w-sm mx-auto">
      <img
      ...
      <p className="text-sm text-gray-500 text-center mb-2">{role}</p>
  ...
  return (
    ...
    <section className="py-20   bg-gray-100">
      <div className="container mx-auto px-4 overflow-hidden"> {/* Apply overflow-hidden here */}
        <h2 className="text-4xl font-bold font-Poppins text-center mb-3  text-[#5e68ff]">
          What Our Service Providers Say
        </h2>
        <h2 className="text-xl font-base font-Poppins text-center mb-8 text-[#6d76ed]">
         Just Review on our Application and get a chance to Featured by us!
        </h2>

        <div className="relative bg-yellw-500 py-20 overflow-hidden"> {/* Apply overflow-hidden here */}
        <button
  className="absolute left-0 transform  -translate-y-1/2 top-1/2 bg-[#5e68f5] text-white px-3 py-1 rounded-xl z-10 font-Poppins  -rotate-90 "
  onClick={prevSlide}
>
  Previous
</button>
          ...
          <motion.div
            ...
            className="grid grid-cols-1 px-10 md:grid-cols-3 gap-6"
          >
          ...
          <button
            className="absolute right-0 transform -translate-y-1/2 top-1/2 bg-[#5e68f5] text-white px-3 py-1 rotate-90 font-Poppins rounded-xl z-10"
            onClick={nextSlide}
          >
            Next
          </button>
